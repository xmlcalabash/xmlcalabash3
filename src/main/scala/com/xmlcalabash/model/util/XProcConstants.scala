...
object XProcConstants {
  ...
  val ns_cc = "http://xmlcalabash.com/ns/configuration"
  ...
  val cc_debug_open_graph = new QName("cc", ns_cc, "debug-open-graph")
  val cc_debug_output_directory = new QName("cc", ns_cc, "debug-output-directory")
  val cc_debug_pipeline = new QName("cc", ns_cc, "debug-pipeline")
  val cc_debug_tree = new QName("cc", ns_cc, "debug-tree")
  val cc_entity_resolver = new QName("cc", ns_cc, "entity-resolver")
  val cc_graph = new QName("cc", ns_cc, "graph")
  val cc_graphviz = new QName("cc", ns_cc, "graphviz")
  val cc_http_proxy = new QName("cc", ns_cc, "http-proxy")
  val cc_load_local_config = new QName("", ns_cc, "load-local-config")
  val cc_loglevel = new QName("", ns_cc, "loglevel")
  val cc_module_uri_resolver = new QName("cc", ns_cc, "module-uri-resolver")
  val cc_run = new QName("cc", ns_cc, "run")
  val cc_safe_mode = new QName("cc", ns_cc, "safe-mode")
  val cc_saxon_configuration = new QName("cc", ns_cc, "saxon-configuration")
  val cc_saxon_configuration_property = new QName("cc", ns_cc, "saxon-configuration-property")
  val cc_schema_aware = new QName("cc", ns_cc, "schema-aware")
  val cc_serialization = new QName("cc", ns_cc, "serialization")
  val cc_show_errors = new QName("cc", ns_cc, "show-errors")
  val cc_stacktrace = new QName("cc", ns_cc, "stacktrace")
  val cc_system_property = new QName("cc", ns_cc, "system-property")
  val cc_thread_count = new QName("cc", ns_cc, "thread-count")
  val cc_trim_inline_whitespace = new QName("cc", ns_cc, "trim-inline-whitespace")
  val cc_unparsed_text_uri_resolver = new QName("cc", ns_cc, "unparsed-text-resolver")
