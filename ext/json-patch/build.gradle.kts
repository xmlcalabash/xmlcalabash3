...
val dep_jsonpatch = project.findProperty("jsonPatch").toString()

dependencies {
  implementation(project(":xmlcalabash"))
  implementation("com.github.java-json-tools:json-patch:${dep_jsonpatch}")
...
publishing {
  ...
  publications {
    create<MavenPublication>("mavenJsonPatch") {
      pom {
...
signing {
  sign(publishing.publications["mavenJsonPatch"])
}
