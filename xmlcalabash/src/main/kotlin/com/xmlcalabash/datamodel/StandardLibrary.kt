...
class StandardLibrary(private val builder: PipelineBuilder, private val stepConfig: StepConfiguration) {
    companion object {
        fun getInstance(builder: PipelineBuilder): StandardLibraryInstruction {
