...
object NsCx {
    ...
    val asciidoctor  = QName(namespace, "cx:asciidoctor")
    val cacheAdd = QName(namespace, "cx:cache-add")
    val cacheDelete = QName(namespace, "cx:cache-delete")
    val collectionManager = QName(namespace, "cx:collection-manager")
    ...
    val rdfGraph = QName(namespace, "cx:rdf-graph")
    val rdfMerge = QName(namespace, "cx:rdf-merge")
    val rdfa = QName(namespace, "cx:rdfa")
    val selenium = QName(namespace, "cx:selenium")
    val sparql = QName(namespace, "cx:sparql")
    val trang = QName(namespace, "cx:trang")
    val trangFiles = QName(namespace, "cx:trang-files")
