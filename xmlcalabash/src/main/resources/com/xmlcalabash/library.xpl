<p:library xmlns:p="http://www.w3.org/ns/xproc"
  ...
  <p:declare-step type="cx:cache-add-document">
    <p:input port="source" sequence="true" content-types="any"/>
    <p:output port="result" sequence="true" content-types="any"/>
  </p:declare-step>

  <p:declare-step type="cx:cache-remove-document">
    <p:input port="source" sequence="true" content-types="any"/>
    <p:output port="result" sequence="true" content-types="any"/>
  </p:declare-step>

  <p:declare-step type="cx:default-input">
    <p:input port="source" content-types="any" sequence="true" primary="true"/>
    <p:input port="default" content-types="any" sequence="true"/>
    <p:output port="result" content-types="any" sequence="true"/>
  </p:declare-step>
  
  <p:declare-step type="cx:document">
    <p:output port="result" content-types="any"/>
  </p:declare-step>

  <p:declare-step type="cx:empty">
    <p:output port="result" sequence="true" content-types="any"/>
  </p:declare-step>
  ...
  <p:declare-step type="cx:guard">
    <p:input port="source" content-types="any" primary="true" sequence="true">
      <p:empty/>
    </p:input>
  </p:declare-step>

  <p:declare-step type="cx:inline">
    <p:input port="source" content-types="any" sequence="true" primary="false">
      <p:empty/>
    </p:input>
    <p:output port="result" content-types="any"/>
  ...
  <p:declare-step type="cx:input-filter">
    <p:input port="source" content-types="any" sequence="true" primary="true"/>
    <p:input port="default" content-types="any" sequence="true"/>
    <p:output port="result" content-types="any" sequence="true"/>
  </p:declare-step>

  <p:declare-step type="cx:select">
    <p:input port="source" content-types="any" sequence="true"/>
    <p:output port="result" content-types="any" sequence="true"/>
  </p:declare-step>
